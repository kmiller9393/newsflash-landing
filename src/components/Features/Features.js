          ...
          <section className="features-section">
            <div className="feature-container">
              ...
              <p className="features-content">
                ...
                relevant news links is created automatically for you, based on
                the most up-to-date technology combined with your personal
                preferences. Love anything sports related? We've got you
                covered. Had enough of Political Drama? You won't see it in your
                feed. YOU are in control of what news you consume
              </p>
            </div>
            <div className="feature-container">
            ...
            <div className="feature-container">
              ...
              <p className="features-content">
                ...
                platform, the more good karma you receive as a user. Down the
                road, this karma will basically equal straight cash $$$. We at
                Newsflash believe that being a good person and being a
                connected, responsible citizen deserves all the rewards we as
                creators of this platform can possibly reward you with.
              </p>
            </div>
          </section>
        </div>
